    ...
    return (
        <div class="container-fluid  gx-0">
            <Helmet
                title="Contact"
            />
            <div className="presentationContact" style={{ backgroundImage: `url(${background2})`,backgroundSize:"cover", }}>
                <div class="image-overlay" id="fondContact">
                    <div class="container" className="contactContainer" >
                        ...
                        <section id="detailContact" class="container-fluid">
                                ...
                                <div className="form">
                                    ...
                                    <button id="btnForm" type="submit" class="btn btn-primary" >Envoyer</button>
                                    </div>
                                </div>
